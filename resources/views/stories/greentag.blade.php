    ...
    <div class="col-md-4 col-sm-8">
      <div class="tabs-left">
        <ul class="nav nav-tabs">
          <li class="active"><a href="#a" data-toggle="tab"><span><h4>Project1</h4></span></a></li>
          <li><a href="#b" data-toggle="tab"><span><h4>Project2</h4></span></a></li>
          <li><a href="#c" data-toggle="tab"><span><h4>Project3</h4></span></a></li>
        </ul>
